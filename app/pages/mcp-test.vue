...
const { executeTool } = (useNuxtApp().$mcp as { executeTool: (toolName: string, params: any) => Promise<any> })
...
<template>
  <div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8">MCP Integration Test</h1>
    
    <!-- Tools Information -->
    <div class="mb-8">
      <h2 class="text-2xl font-semibold mb-4">Available MCP Tools</h2>
      <div v-if="toolsLoading" class="text-gray-500">Loading tools...</div>
      <div v-else-if="toolsError" class="text-red-500">Error loading tools: {{ toolsError }}</div>
      <div v-else-if="tools" class="bg-gray-100 p-4 rounded-lg">
    ...
    <!-- Test Section -->
    <div class="mb-8">
      <h2 class="text-2xl font-semibold mb-4">Test MCP Functionality</h2>
      <UButton 
        @click="testMCPTools" 
        :loading="testing"
        :disabled="testing"
    ...
    <!-- MCP Panel Demo -->
    <div class="mb-8">
      <h2 class="text-2xl font-semibold mb-4">MCP Panel Demo</h2>
      <div class="max-w-md">
        <MCPPanel />
      </div>
    </div>
